...
{   
    public class Base : MonoCache
    {
        ...
        private void Start()
        {
            ...
            ObjectStorage.Instance.Base = this;
        }
        ...
        {
            Miner miner = Instantiate(_miner, _spawnPoint.position, Quaternion.identity);
            ObjectStorage.Instance.MinerLogistics.FindOre(miner);
        }
    }
}
